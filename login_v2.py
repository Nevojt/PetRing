...
"}")
        ...
        self.label_2.setGeometry(QtCore.QRect(60, 20, 250, 200))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../../../../PetRing/image/Sygnet_kolorowy.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(50, 390, 300, 20))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    def login_system(self):
        ...
        if users[username] == password:
            ...
            msg.setStandardButtons(QtWidgets.QMessageBox.Ok)
            msg.exec_()
            subprocess.Popen(["pythonw", ".\\main.py"]) # відкриває новий файл
            Form.close()
        else:
            msg = QtWidgets.QMessageBox()
            msg.setIcon(QtWidgets.QMessageBox.Warning)
    ...
    def login_admin(self):
        ...
        if users[username] == password:
            ...
            msg.setStandardButtons(QtWidgets.QMessageBox.Ok)
            msg.exec_()
            subprocess.Popen(["pythonw", ".\\setting\\update.py"]) # відкриває новий файл
            Form.close()
        else:
            msg = QtWidgets.QMessageBox()
            msg.setIcon(QtWidgets.QMessageBox.Warning)
