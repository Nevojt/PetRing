...
class Ui_MainWindow(object):
    ...
    def update_combobox2(self):
        selected_numer = self.comboBox.currentText()
        gwint_values = self.updateComboBox_2(selected_numer)
        self.comboBox_2.clear()
        self.comboBox_2.addItems(gwint_values)

    def update_combobox3(self):
        selected_numer = self.comboBox.currentText()
        selected_gwint = self.comboBox_2.currentText()
    ...
    def initUIBarwwnik(self):
        ...
        self.comboBox_4.activated.connect(self.update_r_pet_index)
    ...
    def updateComboBox_5(self):
        ...
        self.comboBox_5.addItems(r_pet_list)
        self.comboBox_5.activated.connect(self.update_r_pet_index)
     
     # Заповнюємо comboBox_6 значеннями   
    def updateComboBox_6(self):
        packing = ["1", "3"]
        self.comboBox_6.addItems(packing)
        self.comboBox_6.activated.connect(self.update_r_pet_index)
        
    # Беремо значення кількості преформи в опакованні
    def update_label_packing_list(self):
        selected_item_index = self.comboBox.currentText()
        selected_item_gwint = self.comboBox_2.currentText()
        selected_item_waga = self.comboBox_3.currentText()
    ...
    def update_r_pet_index(self):
        ...
        selected_item_index = self.comboBox.currentText()
        r_pet_index = self.comboBox_5.currentText()
        
        if r_pet_index == "0":
            self.label.setText(f"{self.comboBox.currentText()}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "10":
            selected_item_index_Q = selected_item_index[:1] +"Q" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_Q}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "25":
            selected_item_index_W = selected_item_index[:1] +"W" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_W}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "30":
            selected_item_index_V = selected_item_index[:1] +"V" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_V}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "50":
            selected_item_index_X = selected_item_index[:1] +"X" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_X}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "75":
            selected_item_index_Y = selected_item_index[:1] +"Y" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_Y}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        elif r_pet_index == "100":
            selected_item_index_Z = selected_item_index[:1] +"Z" + selected_item_index[1:]
            self.label.setText(f"{selected_item_index_Z}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}-{self.comboBox_4.currentText()}-{packing_list}-{self.comboBox_6.currentText()}")
        
    
    def cost_start(self):

        color_box_4 = self.comboBox_4.currentText()
        choice_r_pet = self.comboBox_5.currentText()
        index_preforma = f"{self.comboBox.currentText()}-{self.comboBox_2.currentText()}-{self.comboBox_3.currentText()}"
    ...
    def total_cost_raw_material(self):   # Total Cost Raw material for 1000 pcs
        ...
        choice_r_pet = int(self.comboBox_5.currentText()) # R-Pet procentent
    ...
    def total_cost_raw_color(self):
        choice_color = self.comboBox_4.currentText()
        choice_gram = self.comboBox_3.currentText()
    ...
    def upgate_packaging(self):
        choice_packaging = self.comboBox_6.currentText()
        packing_list = self.update_label_packing_list()
    ...
    def update_data(self):
        ...
        self.tableWidget.setItem(1, 1, QtWidgets.QTableWidgetItem(new_data))
        self.tableWidget.setItem(2, 1, QtWidgets.QTableWidgetItem(many_packaging))
        self.tableWidget.setItem(3, 1, QtWidgets.QTableWidgetItem(quantity_product))
        self.tableWidget.setItem(4, 1, QtWidgets.QTableWidgetItem(weight_packaging))
        self.tableWidget.setItem(5, 1, QtWidgets.QTableWidgetItem(f"{cost_raw_machines} zl"))
        self.tableWidget.setItem(6, 1, QtWidgets.QTableWidgetItem(f"{waste_preform} zl"))
        self.tableWidget.setItem(7, 1, QtWidgets.QTableWidgetItem(f"{cost_color} zl"))
        self.tableWidget.setItem(8, 1, QtWidgets.QTableWidgetItem(f"{cost_color_batch} zl"))
        self.tableWidget.setItem(9, 1, QtWidgets.QTableWidgetItem(f"{total_cost_raw} zl"))
        self.tableWidget.setItem(10, 1, QtWidgets.QTableWidgetItem(f"{packing_cost} zl"))
        self.tableWidget.setItem(11, 1, QtWidgets.QTableWidgetItem(f"{cost_start_machine} zl"))
        self.tableWidget.setItem(12, 1, QtWidgets.QTableWidgetItem(f"{cost_machin_tys} zl"))
        self.tableWidget.setItem(13, 1, QtWidgets.QTableWidgetItem(f"{totat_cost_start} zl"))
        self.tableWidget.setItem(14, 1, QtWidgets.QTableWidgetItem(f"{cost_narzut} zl"))
        self.tableWidget.setItem(15, 1, QtWidgets.QTableWidgetItem(f"{finish} zl"))
        self.tableWidget.setItem(16, 1, QtWidgets.QTableWidgetItem(f"{finish} zl"))
        self.tableWidget.setItem(17, 1, QtWidgets.QTableWidgetItem(f"{euro_cost} €"))
    ...
    def quality_cost(self):
        ...
        try:
            quality = self.tableWidget.item(0, 1).text()
    ...
    def total_weight(self):
        ...
        kosz = 67
        new_data = int(self.update_label_packing_list())
        choice_gram = float(self.comboBox_3.currentText())
        choice_packaging = self.comboBox_6.currentText()
    ...
    def generator_pdf(self):
        ...
        index = self.label.text()
        weight = self.comboBox_3.currentText()
    ...
    def color_pdf(self): 
        ...
        color_choice = self.comboBox_4.currentText()
    ...
    def gwint_pdf(self):
        gwint = self.comboBox_2.currentText()
